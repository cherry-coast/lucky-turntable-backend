...
public class CherryStringUtil extends StringUtils {
    ...
    public static boolean isHttp(String link) {
        return StringUtils.startsWithAny(link, StringConstant.HTTP, StringConstant.HTTPS);
    }
    ...
    public static String convertToCamelCase(String name) {
        ...
        if (name == null || name.isEmpty()) {
            // 没必要转换
            return "";
        } else if (!name.contains(StringConstant.UNDER_LINE)) {
            // 不含下划线，仅将首字母大写
    ...
    public static boolean matches(String str, List<String> strs) {
        if (isEmpty(str) || CherryCollectionUtil.listIsEmpty(strs)) {
            return false;
        }
     ...
     * @param str 目标字符串
     * @return 编码后的字符串
     * @throws NoSuchAlgorithmException 未匹配到的算数异常
     */
